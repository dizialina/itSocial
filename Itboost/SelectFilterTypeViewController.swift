//
//  SelectFilterTypeViewController.swift
//  Itboost
//
...
class SelectFilterTypeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let filterCell = tableView.dequeueReusableCell(withIdentifier: "FilterObjectCell", for: indexPath)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let previousViewController = self.navigationController?.viewControllers.first as! FilterViewController
        
        switch filterType! {
        case .country:
            previousViewController.selectedFilters["country"] = selectionList[indexPath.row]
            previousViewController.selectedFilters["city"] = nil
        case .city:
            previousViewController.selectedFilters["city"] = selectionList[indexPath.row]
        }
